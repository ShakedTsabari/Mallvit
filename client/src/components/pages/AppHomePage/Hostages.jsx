            ...
            <a id="bthnLink" target="_blank" href="https://stories.bringthemhomenow.net/?utm_source=www.azrieligroup.com&amp;utm_medium=banner">
                ...
                <div id="bthnTimeBlocks">
                    <div className="bthn-bthn-time-block">
                        <div className="bthn-time">
                            <span className="bthn-digit">{Math.floor(time.days / 100)}</span>
                            <span className="bthn-digit">{Math.floor((time.days % 100) / 10)}</span>
                            <span className="bthn-digit">{time.days % 10}</span>
                        </div>
                        <div>ימים</div>
                    </div>
                    <span className="bthn-dots">:</span>
                    <div className="bthn-bthn-time-block">
                        <div className="bthn-time">
                            <span className="bthn-digit">{Math.floor(time.hours / 10)}</span>
                            <span className="bthn-digit">{time.hours % 10}</span>
                        </div>
                        <div>שעות</div>
                    </div>
                    <span className="bthn-dots">:</span>
                    <div className="bthn-bthn-time-block">
                        <div className="bthn-time">
                            <span className="bthn-digit">{Math.floor(time.minutes / 10)}</span>
                            <span className="bthn-digit">{time.minutes % 10}</span>
                        </div>
                        <div>דקות</div>
                    </div>
                    <span className="bthn-dots">:</span>
                    <div className="bthn-bthn-time-block">
                        <div className="bthn-time">
                            <span className="bthn-digit">{Math.floor(time.seconds / 10)}</span>
                            <span className="bthn-digit">{time.seconds % 10}</span>
                        </div>
                        <div>שניות</div>
                    </div>
                </div>
                <div className="bthn-title-wrap" aria-label="מחזירים אותם הביתה עכשיו">
